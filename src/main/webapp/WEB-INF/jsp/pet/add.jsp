            ...
            <form:form modelAttribute="pet">
                ...
                <div class="form-signin">
                    ...
                    <div class="text-center mb-4">
                        <h1 class="h3 mb-3 font-weight-normal">Yeni Hayvan Ekle</h1>
                    </div>
                    <c:if test="${ownerNotFound ne null}">
                        <div class="alert alert-danger" role="alert">
                            <i class="fa fa-exclamation-triangle mr-2"></i> ${ownerNotFound}
                        </div>
                    </c:if>

                    <c:if test="${ownerNotFound eq null}">
                    <div class="form-row">
