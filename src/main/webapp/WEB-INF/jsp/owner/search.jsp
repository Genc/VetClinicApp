...
<div class="wrapper">
    ...
    <div id="content">
        ...
        <div class="container">
            ...
            <div class="h2 text-center">Hayvan Sahibinin İsmi İle Arama Yapın</div>
            <hr/>
            <c:if test="${notFoundOwners ne null}">
                <div class="alert alert-danger" role="alert">
                    <i class="fa fa-exclamation-triangle mr-2"></i> ${notFoundOwners}
                </div>
            </c:if>
            <form class="form-inline" method="get" action="/owner/search">
                <div class="input-group col-lg-12">
                    <input type="text" name="ownerName" class="form-control"
                           placeholder="Ömer, Yusuf, Faruk gibi hayvan sahibi ismi ile arama yapın..." />
